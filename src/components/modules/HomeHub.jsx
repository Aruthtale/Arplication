...
export default function HomeHub({ setActiveTab }) {
  const modules = [
    ...
    },
    {
      id: 'argame',
      title: 'ArGame',
      tagline: 'Mini Arcade Hub',
      description: 'Koleksi game santai & asah otak offline. Dimulai dari Sudoku 9x9 dengan validasi cerdas.',
      iconUrl: '/Argame.png',
      status: 'Aktif',
      statusColor: 'bg-[#FF8B3D]',
      cardBg: 'bg-[#FFFFFF]',
      accentColor: '#FF8B3D',
      badgeBg: 'bg-[#FF8B3D]',
      actionLabel: 'Mainkan',
